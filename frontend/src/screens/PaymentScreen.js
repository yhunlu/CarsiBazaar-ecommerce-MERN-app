        ...
        <FormContainer>
            ...
            <Form onSubmit={submitHandler}>
                <Form.Group>
                    ...
                    <Col>
                        <Form.Check type='radio' label='PayPal veya Kredi Kartı' id='PayPal' name='paymentMethod' value='PayPal' checked onChange={e => setPaymentMethod(e.target.value)}></Form.Check>
